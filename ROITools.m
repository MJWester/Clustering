...
% Copyright (c) 2017 by Michael J. Wester and Keith A. Lidke
...
% =============================================================================
   ...
   color = ['k', 'b', 'g', 'c', 'm', 'u'];   % Label colors.
...
%    XY_STD           cell array of (x, y) standard deviation of the coordinate
%                     values (nm)
